...
import { Cpu, Mic, RefreshCw, Volume2 } from 'lucide-react';
...
export const Header: React.FC<HeaderProps> = ({ activeTab }) => {
  ...
  return (
    <header className="h-16 border-b border-slate-800/80 bg-[#07090e]/90 backdrop-blur-md px-6 flex items-center justify-between z-20 flex-shrink-0">
      {/* Title & Page info */}
      ...
      {/* Right controls: Visual Status Indicator + Quick Actions */}
      <div className="flex items-center gap-3">
        {/* Quick Voice Trigger */}
        <button
          onClick={handleQuickListen}
          title="Trigger Listen"
